...
/**
 * Сlass for TDLib usage from Java.
 */
public class TlgExample {
    ...
    private static void onAuthorizationStateUpdated(TdApi.AuthorizationState authorizationState) {
        if (authorizationState != null) {
            TlgExample.authorizationState = authorizationState;
        }
        switch (TlgExample.authorizationState.getConstructor()) {
            ...
            case TdApi.AuthorizationStateWaitOtherDeviceConfirmation.CONSTRUCTOR: {
                String link = ((TdApi.AuthorizationStateWaitOtherDeviceConfirmation) TlgExample.authorizationState).link;
            ...
            case TdApi.AuthorizationStateClosed.CONSTRUCTOR:
                ...
                break;
            default:
                System.err.println("Unsupported authorization state:" + newLine + TlgExample.authorizationState);
        }
    }
